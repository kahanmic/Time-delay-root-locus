...
Arguments numP, numD, denP, denD must be matrix notations of quasipolynomial. The P matrix represents coefficients of polynomials
...
Each row in P matrix, k = 1,...,N is specific for given delay and each column l = 1,...,n specifies coefficient for given order of monomial. Coefficient l = 1 is tied to s^(n-1), ... l = n is coefficient of a constant. "num" and "den" specifies numerator or denominator quasipolynomial. Numerator and denominator matrices may not have same delays.
